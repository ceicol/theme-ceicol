...
var themeOptions = {
  palette: {
    ...
    green: {
      ...
      button: "#059669",
      // compat theme-gaia (green.button, tono sólido oscuro)
      contrastText: brandColors.text.white
    },
    brown: {
...
var gaiaCompatTheme = (0, import_styles2.createTheme)(gaiaCompatOptions);
gaiaCompatTheme = (0, import_styles2.responsiveFontSizes)(gaiaCompatTheme);
