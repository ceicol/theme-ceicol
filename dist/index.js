...
var brandColors = {
  ...
  primary: {
    ...
    light: "#0391b2",
    lighter: "#3cbfe0",
    // texto/borde de marca en dark — AAA sobre superficies oscuras
    dark: "#005a7a",
    bg: "#e1f0f8"
...
var fontSizes = {
  ...
  h4: fluid(24, 20),
  // 20→24px — subtítulo de sección. MOVIDO en el major.
  h5: fluid(18, 16),
  // 16→18px — título compacto. Es el `h4` anterior.
  h6: "1rem",
  // 16px fijo — el más pequeño en display
  ...
  xxs: "0.65rem",
  // 10.4px — MÍNIMO ABSOLUTO. Microetiqueta: una o dos
...
var typography = {
  ...
  body2: {
    ...
    // 14px — el cuerpo pequeño que esos diez suponen
    lineHeight: 1.5
  },
...
var shadows = {
  ...
  // sombra de CTA de marca (reposo)
  buttonHover: "0 6px 20px rgba(0, 114, 152, 0.3)"
  // sombra de CTA de marca (hover)
};
...
var animations = {
  ...
  duration: {
    instant: 90,
    // micro-feedback táctil: press, tick, anillo de foco
    fast: 150,
    // hover, color/fondo, cambios de estado pequeños
    normal: 250,
    // transición por defecto
    slow: 300
    // superficies, paneles, reveals mayores
  },
  easing: {
