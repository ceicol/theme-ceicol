...
var brandColors = {
  ...
  // Gaia expone `cta` (su dorado). En CEICOL el CTA es el azul de marca,
  // así que apunta a primary para que un producto que migra adopte el azul.
  cta: {
    main: "#007298",
    light: "#0391b2"
  },
...
var spacingConstants = {
  ...
  xl: "80px",
  xxl: "140px",
  // Compat theme-gaia (deprecado): nombres de clave que Gaia usa y CEICOL no.
  // Apuntan a los valores de CEICOL para que la migración adopte su escala.
  min: "8px",
  // Gaia `min` → equivalente a CEICOL xs
  base: "16px"
  // Gaia `base` → equivalente a CEICOL sm
};
...
var transitionStyles = {
  ...
  // Se mapean al movimiento de CEICOL (rápido y directo), por lo que un
  // producto que migra adopta el ritmo de CEICOL
...
var themeOptions = {
  palette: {
    ...
    brown: {
      ...
      // compat theme-gaia (fondo/borde sutil)
      contrastText: brandColors.text.white
    },
    link: {
      main: brandColors.primary.main,
